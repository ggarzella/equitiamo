<?php get_header(); ?>
	...
	<?php get_template_part('includes/index', 'carousel'); ?>
		...
		<div class="col-md-12 attivita nopadding" id="attivita">
			<div class="in-panel">
		...
		<div class="col-md-12 contatti nopadding" id="contatti">
			<div class="mask">
				<div class="in-panel">
		...
		<div class="col-md-12 dove-siamo nopadding" id="dove-siamo">
			<div class="in-panel">
		...
		<div class="col-md-12 prezzi nopadding" id="prezzi">
			<div class="mask">
				<div class="in-panel">
		...
		<div class="col-md-12 social nopadding" id="social">
